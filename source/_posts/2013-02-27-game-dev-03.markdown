...
{% img right /images/posts/game-dev-move-02.png [what's the delta between the angles?]%}
...
{% img right /images/posts/game-dev-move-02.png [turning the wrong way]%}
...
_The canvas is a broad topic in itself. I recommend taking a look at the tutorials over at [MDN](https://developer.mozilla.org/en-US/docs/HTML/Canvas). A handy reference for the APIs themselves can be found on [MSDN](http://msdn.microsoft.com/en-us/library/ff975057(v=vs.85).aspx)._